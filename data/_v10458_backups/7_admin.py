"""pages/7_admin.py — Administration centre: users, permissions, reporting lines, audit, staff_performance oversight (My Staff Performance drill via Chief HR Centre)."""
