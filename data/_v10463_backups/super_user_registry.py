...
SUPER_USER_MAP: Dict[str, Dict[str, Any]] = {
    ...
    # v10.461 - Finance Chief (Chief Finance Officer covers BOTH
    # finance + treasury per Joshua continue v10.461).
    "finance": {
        "primary_role": "Chief Finance Officer",
        ...
        "notes": "Finance organ super_user is CFO; CFO command centre "
                "covers BOTH finance and treasury per Joshua doctrine.",
    },
    # v10.461 - Treasury Head (Treasury is almost stand-alone with its
    # own head and dedicated command centre per Joshua).
    "treasury": {
        "primary_role": "Head of Treasury",
        "primary_title": "Head of Treasury / Treasury Super User",
        "secondary_role": "Chief Finance Officer",
        "escalation_path": [
            "Dealer",
            "Senior Dealer",
            "Treasury Manager",
            "Head of Treasury",
            "Chief Finance Officer",  # Reports up to CFO
            "ICT Super User",
            "MD",
        ],
    ...
    # v10.461 - Legal Chief (Company Secretary is the Chief per Joshua).
    "legal": {
        "primary_role": "Company Secretary",
        ...
        "escalation_path": [
            ...
            "Head of Legal",
            "Company Secretary",  # Chief per Joshua
            "ICT Super User",
            "MD",
            "Board",
        ],
        "notes": "Legal organ chief is the Company Secretary per Joshua; "
                "escalation continues to the Board for governance "
                "matters.",
    },
    # v10.461 - Risk Chief (Chief Risk Officer covers BOTH risk +
    # compliance per Joshua, mirroring CFO covering finance + treasury).
    "risk": {
    ...
    # v10.461 - Compliance Head (sub-organ of risk, separate centre).
    "compliance": {
        "primary_role": "Head of Compliance",
        ...
        "notes": "Compliance organ has its own Head + dedicated centre "
                "per Joshua; reports up to CRO.",
    },
}
