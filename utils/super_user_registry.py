...
SUPER_USER_MAP: Dict[str, Dict[str, Any]] = {
    ...
    # v10.465 - Operations Chief (Chief Operating Officer per actual
    # users.json; Grace Makokha 300008). COO oversees branch ops,
    # centralized processing, service delivery, SLAs, EDMS, CIMS,
    # approvals, fraud, clearing, projects, procurement, vendors,
    # assets, contracts, SWIFT.
    "operations": {
        "primary_role": "Chief Operating Officer",  # Actual in users.json
        "primary_title": "COO / Operations Super User",
        "secondary_role": "ICT Super User",
        "escalation_path": [
            "Operations Officer",
        ...
        "notes": "Operations organ chief is COO (Chief Operating "
                "Officer). EDMS, CIMS, SLA, and approvals are SHARED "
                "modules with broad secondary_visibility per Joshua "
                "mantra (used across all organs).",
    },
    # v10.465 - CRM organ - SHARED between CRBO (Chief Retail Banking
    # Officer Nicholas Ndegwa) and CCO (Chief Commercial Officer
    # Emmanuel Kuria). Each chief gets their own command centre
    # filtering by staff hierarchy. Pipeline enables every staff to
    # create a lead per Joshua doctrine.
    "crm": {
        "primary_role": "Chief Retail Banking Officer",  # Primary
        "primary_title": "CRBO / CRM Retail Super User",
        "secondary_role": "Chief Commercial Officer",    # Co-chief
        "escalation_path": [
        ...
        "notes": "CRM organ is SHARED between CRBO and CCO per Joshua "
                "doctrine. v10.466 will add two parallel command "
                "centres (CRBO + CCO) filtering by staff hierarchy. "
                "Pipeline allows every staff to create a lead; "
                "support staff can assign leads.",
    },
    # v10.465 - Reporting & Analytics organ. Top-level diagnostic
    # organ. No dedicated chief in current users.json - reports up
    # via Head of Analytics (placeholder) to MD. May be aligned with
    # COO or CFO in future based on Joshua direction.
    "reporting_analytics": {
        "primary_role": "Head of Analytics",  # Placeholder
        "primary_title": "Head of Analytics / Analytics Super User",
        "secondary_role": "Chief Operating Officer",
        "escalation_path": [
            "Data Analyst",
            "Senior Analyst",
            "Analytics Manager",
            "Head of Analytics",
            "Chief Operating Officer",  # Provisional alignment
            "ICT Super User",
            "Chief Executive & Managing Director",
        ],
        "notes": "Reporting & Analytics is the body's diagnostic "
                "system per mantra doc. Provisional reporting to COO "
                "until Joshua confirms alignment. Could alternatively "
                "report to CFO or via MD directly.",
    },
}
