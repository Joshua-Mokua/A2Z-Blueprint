...
PARTNERS = [
    "Acumen Advisory", "African Enterprice International", "Africa Gas & Oil Company",
    "Africa Re Insurance Corporation", "African Telecommunication Union",
    "Africa Trade Insurance (Ati)", "African Wildlife Foundation",
    "African Field Epidemiology Network (Afenet)", "African Management Institute",
    "African Population And Health Research Center (Aprhc)", "African Union",
    "African Union - Cdc", "African Union - Ibar", "African Union - Nrc",
    "Aga-Khan Hospital Kisumu", "All Africa Conference Of Churches",
    "Alliance For A Green Revolution In Africa Agra", "American Friends Service",
    "Asharami Synergy Kenya Limited", "Atlascopco", "Axxonsoft Mena Fzco",
    "Baraton University", "Batuk", "Britam Insurance", "British American Tobacco",
    "Bulkstream Limited", "Bulkstream Logistics", "Business Cashbacked", "Cfao",
    "CIC Insurance", "Coast Development Authority", "Communivity Initiatives Concern",
    "Compassion International", "Embassy Of Senegal", "Express Shipping And Logistics",
    "Flexi Personel", "Geothermal Development Company", "Ghana Reinsurance Ltd",
    "Giz Kenya", "International Planned Parenthood Federation (Ippf)",
    "International Rescue Committee", "Jaramogi Oginga Odinga University",
    "Jomo Kenyatta University Of Agriculture And Technology (Jkuat)", "Jubilee Insurance",
    "Kamu Limited", "Karen Hospital", "Kenya Agricultural & Livestock (Kalro)",
    "Kenya Bureau Of Standards", "Kenya Medical Supplies Authority",
    "Kenya Medical Training College", "Kenyatta National Hospital", "KICC",
    "Kisii University", "Lake Victoria Basin Cimmission (Lvbc)", "Lukenya Gataway Ltd",
    "Maseno University", "Mater Hospital", "Mbaraki Bulk", "Menengai Oil",
    "Moi Teaching And Referral Hospital", "Moi University Eldoret", "Mpesa Academy",
    "National Government- Westlands Contituency", "Nedbank",
    "New Kenya Cooperative Creameries", "Norwegian Refugee Council",
    "Office Of The Auditor General", "Ola", "One Commodities", "One Petroleum",
    "Pharmacy And Poisons Board", "Phillips East Africa Limited",
    "Price Waterhouse Cooperation", "Pwani Oil", "Pwani Oil (Unemployed)",
    "Rongo University", "Royal Golf", "Rwandair", "Sanlam Annuitant",
    "SDA Advent Hill Primary School", "SDA Herald Publishing House",
    "SDA Central Kenya Conference", "SDA Central Nyanza Conference",
    "SDA Central Rift Conference",
    "SDA East Nairobi Field", "SDA East-Central Africa Division",
    "SDA Greater Rift Valley", "SDA Home Health Education Services",
    "SDA Karura School", "SDA Kenya Lake Conference",
    "SDA Maxwell Adventist Preparatory", "SDA Nairobi Central", "SDA Newlife",
    "SDA North East Kenya Field", "SDA North West Kenya Field",
    "SDA South East Kenya Field", "SDA South Kenya Conference",
    "SDA South West Kenya Field", "SDA Southern Kenya Lake Conference",
    "SDA West Kenya Union Conference", "SDA West Nyanza Field", "SDA West Rift Field",
    "Shelter Afrique", "Teachers Service Commission", "Technical University Of Kenya",
    "Telkom Kenya Ltd", "The University Of Nairobi", "Tolaram", "Trustgro",
    "Trustgro(Equity)", "United Nation", "University Of Eldoret", "Waica-Re",
    "World Scouts Organization", "Yehu Microfinance",
]
