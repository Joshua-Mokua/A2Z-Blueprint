# CRM & Customer Functions Module — Remediation Roadmap
...
- Module: CRM & Customer Functions Module
...
- [ ] crm_module_revival.md (criterion #12)
- [ ] crm_capacity_plan.md doc (criterion #14)
