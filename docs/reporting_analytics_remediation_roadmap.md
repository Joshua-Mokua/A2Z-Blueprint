# Reporting & Analytics Module — Remediation Roadmap
...
- Module: Reporting & Analytics Module
...
- [ ] reporting_analytics_module_revival.md (criterion #12)
- [ ] reporting_analytics_capacity_plan.md doc (criterion #14)
