# Legal Module Module — Revival Documentation

**Organ:** LEGAL — *Bony Skeleton & Constitutional Framework*
**Doctrine head:** Company Secretary and Chief Legal Officer (Mark Charo, 300010)
**Pages claimed:** 3
**Engines:** 13
**Core functions:** case management, document management, holds, board governance, spend management
...
| Phase 5 | BSC & Actuals Intelligence Wiring | ✅ Complete — auto-population from `legal_actuals_engine.py` |
...
roadmap. Functions covered: case management, document management, holds, board governance, spend management.
...
legal organ is ≥90%, with **zero unwired standards** as of v10.468.
...
The `legal_actuals_engine.py` actuals engine auto-populates KPI actuals
...
- **Stress testing & benchmarks**: see `docs/legal/capacity_plan.md`
- **Adoption metrics**: see `docs/legal/adoption_report.md`
- **Horizontal scaling plan**: see `docs/legal/capacity_plan.md`
- **Flexcube integration**: see `utils/flexcube_adapter.py`
- **BSC actuals engine**: see `utils/legal_actuals_engine.py`
...
| 7 | legal_actuals_engine.py exists | ✅ |
