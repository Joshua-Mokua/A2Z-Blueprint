# Treasury Module Module — Revival Documentation

**Organ:** TREASURY — *Cash Flow Reservoir & Arterial Blood Pressure*
**Doctrine head:** Head of Treasury (Bernadette Murithi, 300164) under CFO
**Pages claimed:** 7
**Engines:** 21
**Core functions:** ALM, FTP, FX, liquidity stress, market risk VAR, treasury products
...
| Phase 5 | BSC & Actuals Intelligence Wiring | ✅ Complete — auto-population from `treasury_actuals_engine.py` |
...
roadmap. Functions covered: ALM, FTP, FX, liquidity stress, market risk VAR, treasury products.
...
treasury organ is ≥90%, with **zero unwired standards** as of v10.468.
...
The `treasury_actuals_engine.py` actuals engine auto-populates KPI actuals
...
- **Stress testing & benchmarks**: see `docs/treasury/capacity_plan.md`
- **Adoption metrics**: see `docs/treasury/adoption_report.md`
- **Horizontal scaling plan**: see `docs/treasury/capacity_plan.md`
- **Flexcube integration**: see `utils/flexcube_adapter.py`
- **BSC actuals engine**: see `utils/treasury_actuals_engine.py`
...
| 7 | treasury_actuals_engine.py exists | ✅ |
