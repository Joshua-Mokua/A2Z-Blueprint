# A2Z MIS 360 — Master prompt (v4.83)
...
**Current version: v10.440 (May 2026) - HR Rescue Arc Batch 3: wire #18 + #19 engines.** Per v10.436 audit: 4 of 6 HR closed-standards engines unwired. v10.438 wired #14+#17; v10.440 wires #18+#19. efficiency (Std #18, EfficiencyEngine) into 43_pip.py as new Efficiency Insights tab using calculate_efficiency_scores; per-KPI personal efficiency vs peer average; flags below-peer KPIs as PIP improvement targets. wellness (Std #19, WellnessEngine) into 2_people.py as new Wellness section with 3 sub-tabs (My wellness check, Team alerts, How this works) using assess_burnout_risk + list_alerts_for_manager; ethical guardrails preserved per G30 audit gate: forbidden words (depressed/burnt out/stress disorder/mental health/anxiety) documented; opt-out via wellness_monitoring_disabled respected; recommendations focus on workload/process not personal traits. PIP 4->5 tabs (135->244 LOC). People 5->6 sections (3902->4034 LOC). Result: HR engine wiring 50%->75% (6 of 8 wired); HR Health 61.7%->69.2%. Remaining 2 unwired (staff_onboarding_engine + staff_exit_engine) need NEW pages in v10.441. UI-WIRING batch no engines built. 360 harmony 100% preserved; BSC rescue 100%; standards wiring 78.8%; engine 0/0/0/0.
