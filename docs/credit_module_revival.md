# Credit Module Module — Revival Documentation

**Organ:** CREDIT — *Heart of the bank*
**Doctrine head:** Chief Credit Officer (Gregory Chirchir, 300005)
**Pages claimed:** 12
**Engines:** 8
**Core functions:** credit appraisal, IFRS9 staging, NPL management, collections, credit committee
...
| Phase 5 | BSC & Actuals Intelligence Wiring | ✅ Complete — auto-population from `credit_actuals_engine.py` |
...
roadmap. Functions covered: credit appraisal, IFRS9 staging, NPL management, collections, credit committee.
...
credit organ is ≥90%, with **zero unwired standards** as of v10.468.
...
The `credit_actuals_engine.py` actuals engine auto-populates KPI actuals
...
- **Stress testing & benchmarks**: see `docs/credit/capacity_plan.md`
- **Adoption metrics**: see `docs/credit/adoption_report.md`
- **Horizontal scaling plan**: see `docs/credit/capacity_plan.md`
- **Flexcube integration**: see `utils/flexcube_adapter.py`
- **BSC actuals engine**: see `utils/credit_actuals_engine.py`
...
| 7 | credit_actuals_engine.py exists | ✅ |
