# A2Z MIS 360 — Master prompt (v4.41)
...
**Current version: v10.398 (May 2026) — HQ canonical extension per Joshua's directive + hr.json dedup.** Resolves TC42 (HQ specialist canonical gap). Per Joshua 2026-05-13: every HQ role mapped to a chief. **4 new chiefs** added to canonical: CCO (Chief Commercial Officer), Chief Credit Officer, Chief Internal Auditor (Chief Audit per Joshua), GM Bancassurance. All chiefs report to MD. Chief Compliance Officer reports to CRO per Joshua's "compliance reports here" directive. Bancassurance Officer reports to Branch Manager primary with GM Bancassurance as dotted line / HQ fallback. CFO subtree: Financial Controller, Finance Manager, Tax, Business Analytics, Treasury (Head + Senior Manager + Dealers + Forex Trader). CRO subtree: Risk Manager + Operational Risk Manager + Chief Compliance Officer + Regulatory Compliance Officer. CIO subtree: Head of ICT + Database/Network/Core Banking/Sys Admin Managers + DFS (Agency/Mobile/Card mgrs) + technical officers (PHP Developer, Cyber, ICT Support). COO subtree: Head of Operations + Central Processing + Clearing + Cash Centre + Trade Finance Operations + Marketing + Procurement + CX + Facilities. CHRO subtree: HRBP roles + HR Officers. CRBO extended: Head of Branches + Head of Women Banking + Senior Manager Diaspora + Senior Manager Direct Sales Force (Business Development = DSR oversight per Joshua) + RM Diaspora. CCO subtree: Head Of Corporates & Trade Finance + Head of MSME + Head of GIB + all RMs. Chief Credit Officer subtree: Senior Manager Credit Analysis + Corporate/Consumer Analysis Managers + Credit Analysts + Credit Admin + Collections & Recoveries + Write-Off. Chief Internal Auditor subtree: Senior Manager Internal Audit + Internal Auditors. GM Bancassurance subtree: Manager Underwriting + HQ Bancassurance. **hr.json dedup**: 8 duplicate staff_codes (300004/300200/300238/300328/301021/301093/301141/301235) renumbered to fresh range 901000+. **Rep-sender detector refined**: now skips leaf roles (only flags canonical managers — Tellers/CSOs/RMs no longer over-flagged). Engine audit after extension: 0 cycles ✓, 0 cross-branch ✓, 0 multi-sender ✓, **0 rep_critical** ✓ (was 53 in v10.397, TC42 RESOLVED). 130 role_manager_whitelist entries (was 27 in v10.396), 127 role_tier updates. Cascade size: 1,051 → 23,069 (v10.397) → **25,488** (v10.398). 7 hanging roles surfaced for Joshua's clarification.
