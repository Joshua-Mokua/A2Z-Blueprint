...
NEW_KPIS = {
    ...
    "CREDIT_REWORK_RATE":    {"name":"Credit Rework Rate",           "unit":"%",  "direction":"lower", "pillar":"Operational Excellence","default_weight":0.15,"cbs_source":"loan_applications"},
    "CREDIT_TAT_EXPRESS":    {"name":"Credit TAT — Express Lane",    "unit":"days","direction":"lower","pillar":"Operational Excellence","default_weight":0.15,"cbs_source":"loan_applications"},
    "CREDIT_TAT_STANDARD":   {"name":"Credit TAT — Standard Lane",   "unit":"days","direction":"lower","pillar":"Operational Excellence","default_weight":0.15,"cbs_source":"loan_applications"},
    "CREDIT_TAT_COMPLEX":    {"name":"Credit TAT — Complex Lane",    "unit":"days","direction":"lower","pillar":"Operational Excellence","default_weight":0.10,"cbs_source":"loan_applications"},
    ...
    "LOAN_DISBURSEMENT_TAT": {"name":"Loan Disbursement TAT",        "unit":"days","direction":"lower","pillar":"Operational Excellence","default_weight":0.15,"cbs_source":"credit_admin"},
    # Legal team KPIs
    "LEGAL_SLA_SECURITY":    {"name":"Legal TAT — Security Perfection","unit":"%","direction":"higher","pillar":"Operational Excellence","default_weight":0.20,"cbs_source":"legal_matters"},
    "LEGAL_SLA_DOCS":        {"name":"Legal TAT — Loan Documentation", "unit":"%","direction":"higher","pillar":"Operational Excellence","default_weight":0.20,"cbs_source":"legal_matters"},
    "LEGAL_SLA_ATTORNEY":    {"name":"Legal TAT — External Counsel",   "unit":"%","direction":"higher","pillar":"Operational Excellence","default_weight":0.15,"cbs_source":"legal_matters"},
    "LEGAL_SLA_VALUATION":   {"name":"Legal TAT — Valuation",          "unit":"%","direction":"higher","pillar":"Operational Excellence","default_weight":0.15,"cbs_source":"legal_matters"},
    "LEGAL_SLA_CUSTODY":     {"name":"Legal TAT — Title Deed Custody", "unit":"%","direction":"higher","pillar":"Operational Excellence","default_weight":0.10,"cbs_source":"legal_matters"},
    "LEGAL_SLA_OPINION":     {"name":"Legal TAT — Legal Opinion",      "unit":"%","direction":"higher","pillar":"Operational Excellence","default_weight":0.10,"cbs_source":"legal_matters"},
    "LEGAL_OVERDUE_RATE":    {"name":"Legal Overdue Rate",             "unit":"%","direction":"lower","pillar":"Operational Excellence","default_weight":0.10,"cbs_source":"legal_matters"},
    # Treasury KPIs
    ...
    "TREASURY_FD_TAT":       {"name":"FD Ratification TAT",            "unit":"days","direction":"lower","pillar":"Operational Excellence","default_weight":0.20,"cbs_source":"treasury_fd"},
    "TREASURY_FD_APPROVAL":  {"name":"FD Approval Rate",               "unit":"%","direction":"higher","pillar":"Operational Excellence","default_weight":0.20,"cbs_source":"treasury_fd"},
    ...
    # Compliance KPIs
    "COMP_CLEARANCE_RATE":   {"name":"Compliance Case Clearance Rate", "unit":"%","direction":"higher","pillar":"Operational Excellence","default_weight":0.30,"cbs_source":"compliance_cases"},
    "COMP_SLA_CRITICAL":     {"name":"Compliance SLA — Critical Cases","unit":"%","direction":"higher","pillar":"Operational Excellence","default_weight":0.25,"cbs_source":"compliance_cases"},
    "COMP_SLA_HIGH":         {"name":"Compliance SLA — High Risk Cases","unit":"%","direction":"higher","pillar":"Operational Excellence","default_weight":0.20,"cbs_source":"compliance_cases"},
    "COMP_OPEN_CASES":       {"name":"Open Compliance Cases",          "unit":"count","direction":"lower","pillar":"Operational Excellence","default_weight":0.15,"cbs_source":"compliance_cases"},
    "COMP_ESCALATION_RATE":  {"name":"Compliance Escalation Rate",     "unit":"%","direction":"lower","pillar":"Operational Excellence","default_weight":0.10,"cbs_source":"compliance_cases"},
}
